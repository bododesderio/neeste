...
export default function Contact() {
  ...
  const primaryColor = settings?.primary_color || theme.accent || "#f59e0b";
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-10">
          ...
          <p className="mt-2 text-white/70">
            {settings?.contact_description || "Have questions? We'd love to hear from you."}
          </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 outline-none focus:border-amber-500"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 outline-none focus:border-amber-500 resize-none"
                    required
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 rounded-2xl text-black font-semibold hover:opacity-90 transition-opacity disabled:opacity-50"
                >
                  ...
                  {settings?.email && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-1">{settings.email}</div>
                      </div>
                    </div>
                  )}
                </div>
